...
export const metadata: Metadata = { title: "Capabilities", description: "Explore Faith Oluwalana's work across product development, frontend engineering, AI, data and Web3." };
