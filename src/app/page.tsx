...
export default function Home() {
  return <main className="home-page">
    <section className="intro-stage" aria-labelledby="intro-title">
      ...
      <div className="intro-center"><Link className="latest-project" href="/work"><span className="latest-thumb"><Image src={projects[0].image} alt="" fill sizes="34px" /></span><span>Explore my work</span><span aria-hidden="true">↗</span></Link><p className="intro-kicker">SOFTWARE DEVELOPER · PRODUCT BUILDER</p><h1 id="intro-title">Hi, I&apos;m Oluwalana Faith.<br /><span>Building products that <em>matter.</em></span></h1><p className="intro-description">I design and build thoughtful digital experiences across AI, Web3, data and the modern web.</p></div>
